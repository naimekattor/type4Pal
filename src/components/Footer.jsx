        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-6 border-b border-gray-200">
          ...
          <div className="flex-shrink-0">
            <img
              ...
              alt="type4 pal logo"
              loading="lazy"
              className="max-h-[60px] md:max-h-[80px] w-auto mx-auto md:mx-0"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full md:w-auto">
            ...
            <div className="flex justify-center space-x-4">
              ...
              >
                <FaFacebookSquare className="text-2xl sm:text-3xl hover:text-[#004f42]" />
              </Link>
              <Link
                target="_blank"
                to="https://www.tiktok.com/@type4.pal?_t=ZS-8ysTCwghFcP&_r=1"
              >
                <AiFillTikTok className="text-2xl sm:text-3xl hover:text-[#004f42]" />
              </Link>
              <Link target="_blank" to="https://www.instagram.com/type4pal/">
                <FaInstagramSquare className="text-2xl sm:text-3xl hover:text-[#004f42]" />
              </Link>
              <Link target="_blank" to="https://pin.it/6VXi3toRC">
                <FaPinterest className="text-2xl sm:text-3xl hover:text-[#004f42]" />
              </Link>
              <Link
                target="_blank"
                to="https://www.reddit.com/r/Type4Pal/s/A4KISnEKNn"
              >
                <FaReddit className="text-2xl sm:text-3xl hover:text-[#004f42]" />
              </Link>
            </div>
          </div>
        </div>
